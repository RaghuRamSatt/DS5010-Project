...
def odds_ratio(exposed_yes, not_exposed_yes, exposed_no, not_exposed_no):
    ...
    Returns
    -------
    odds - odds of an event occurring
    """
...
def relative_risk(exposed_yes, not_exposed_yes, exposed_no, not_exposed_no):
    ...
    Function
    --------
    calculates the risk of an outcome occuring between a case group and control
    used when comparing the likelihood of an outcome occuring
